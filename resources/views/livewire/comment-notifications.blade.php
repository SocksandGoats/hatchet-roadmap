...
>
    ...
    >
        ...
        @elseif ($isLoading)
            ...
            @endforeach
        @else
            <li class="mx-auto py-6">
                <div class="w-full flex space-x-2 justify-center text-center items-center">
                    <i class="fa-regular fa-lightbulb"></i>
                    <div class="text-gray-400 text-center font-bold">No new notifications</div>
                </div>
            </li>
        @endif
    </ul>
